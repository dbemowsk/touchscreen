...
// Defines a counter value to check for pauses in button presses
pauseTimer = 0;

// Defines the number of seconds before a pause is detected
pauseTimeout = 4;

// Defines a flag to tell when buttons were pressed and to check the timeout
buttonPressFlag = false;

//  Set a timer to run every second to check the button press timeout.
window.setInterval(sbPauseTimer, 1000);

// Function sbPauseTimer() is a handler for the button pause timer.
function sbPauseTimer() {
  if (buttonPressFlag) {
